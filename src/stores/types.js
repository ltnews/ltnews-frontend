...
export const RESET_STATE_PROFILE_IMAGE = 'RESET_STATE_PROFILE_IMAGE'
...
export const PASSWORD_NEW_RESET = 'PASSWORD_NEW_RESET'
export const PASSWORD_EMAIL = 'PASSWORD_EMAIL'
export const PASSWORD_EMAIL_RESET = 'PASSWORD_EMAIL_RESET'
...
export const PROFILE_GET_ONE = 'PROFILE_GET_ONE'
export const PROFILE_INIT = 'PROFILE_INIT'
export const PROFILE_PUT = 'PROFILE_PUT'
export const PROFILE_OLD = 'PROFILE_OLD'
export const PROFILE_IMAGE_PUT = 'PROFILE_IMAGE_PUT'
export const PROFILE_IMAGE_OLD = 'PROFILE_IMAGE_OLD'
...
export const ITEM_GET_ONE_KEYWORDS = 'ITEM_GET_ONE_KEYWORDS';
export const ITEM_GET_ONE_SIMILARITY = 'ITEM_GET_ONE_SIMILARITY';
